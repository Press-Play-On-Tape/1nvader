...
namespace Images {
    ...
    namespace Portrait {
        ...
        namespace Normal {
            ...
            8, 16,
            0x74, 0xf8, 0x8e, 0xde, 0xfa, 0x50, 0x50, 0x00, 0x01, 0x00, 0x03, 0x03,
            0x02, 0x00, 0x00, 0x00,
            };

            const uint8_t PROGMEM Player2_Mask[] = {
            0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xf8, 0xf8, 0x03, 0x07, 0x07, 0x07,
            0x07, 0x07, 0x00, 0x00,
            };
        ...
        namespace Rotated {
            ...
            const uint8_t PROGMEM Player2[] = {
            8, 16,
            0x00, 0x50, 0x50, 0x72, 0xde, 0x8e, 0xf8, 0x74, 0x00, 0x00, 0x00, 0x02,
            0x03, 0x03, 0x00, 0x01,
            };

            const uint8_t PROGMEM Player2_Mask[] = {
            0xf8, 0xf8, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0x00, 0x00, 0x07, 0x07,
            0x07, 0x07, 0x07, 0x03,
            };
    ...
    namespace Landscape {
        ...
        const uint8_t PROGMEM Player2[] = {
        11, 8,
        0x00, 0x38, 0xb0, 0x78, 0xde, 0xc8, 0xde, 0x78, 0xb0, 0x38, 0x00,
        };

        const uint8_t PROGMEM Player2_Mask[] = {
        0x7c, 0xfc, 0xfc, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc, 0xfc, 0x7c,
        };
